...
using CQRSMediatrWithFVAndAutoMapperSampleApplication.Product.Notify;
using CQRSMediatrWithFVAndAutoMapperSampleApplication.Product.Query;
using MediatR;
using Microsoft.AspNetCore.Mvc;

namespace CQRSMediatrWithFVAndAutoMapperSampleApi.Controllers
{
    [ApiController]
    [Route("[controller]")]
